...
?>
    ...
    <hr><br /><br /><br />
    <h6><?php echo 'Compléter et valider :'; ?></h6>

    <form id="observation_du_ap" name="observation_du_ap" method="post" action="<?= site_url(); ?>/traitement-de-lobservation-du-responsable-de-la-structure/">
      <label for="date_consultation_chef_structure">Date de consultation : </label><input type="date" value="<?= date('Y-m-d'); ?>" name="date_consultation_chef_structure" /> <br /><br />
