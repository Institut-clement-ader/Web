        ...
        <table class="table">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td> <?php
                            if ($row['contact_resp'] == 1) :
                                echo TXT_YES;
                            else :
                                echo TXT_NO;
                            endif; ?></td>
                    <td> <a href="<?= $site . LIEN_RESERVATION ?>?id=<?= $row[0] ?>"><i class="fa-solid fa-eye"></i></a>
                        <a href="<?= $site . LIEN_MODIFIER ?>?id=<?= $row[0] ?>"><i class="fa-solid fa-edit"></i></a>
                        <a href="<?= $site . LIEN_SUPPRIMER ?>?id=<?= $row[0] ?>"><i class="fa-solid fa-times-circle "></i></a>
                </tr>
            <?php } ?>
        </table>
    <?php }
