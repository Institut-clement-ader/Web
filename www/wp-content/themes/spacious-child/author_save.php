           ...
           echo '<tr>';
             echo '<td>';
               ...
               function is_url_exist($url){
                ...
                $pathtoImage = "http://institut-clement-ader.org/imagesPerso/".($curauth->nickname).".jpg"; 
                ...
                //si il n'y a aucune image
                  ...
                  echo '<div id="photo_profil"> <img src= http://institut-clement-ader.org/imagesPerso/default.png /> </div>';
                }
        ...
        echo $nbResultats.' contributions trouvées';
         //permettre de télécharger la fiche Excel si l'utilisateur est connecté
          if ( is_user_logged_in() ) {
            echo "<br /><br /><FORM METHOD='POST' ACTION='http://institut-clement-ader.org/excel-des-publications/' CLASS='form-publi'>";
