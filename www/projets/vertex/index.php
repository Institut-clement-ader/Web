  ...
  <div id="header-region" class="clear-block"></div> 
    ...
    <div id="container" class="clear-block"> 
     <div id="header"> 
        ...
        <div id="titol-lacan"> 
          <a href="http://www.institut-clement-ader.org/projets/icare/" title="ANR ICARE"><div id="header-text-lacan"> <h5>Projet VERTEX</h5></a>
</div></div> 
        <div id="titol-upc"> 
            <a href="http://www.institut-clement-ader.org/projets/vertex" title="ANR Vertex"><div id="header-text-upc">VERTEX ANR-12-RMNP-0001</div></a>
