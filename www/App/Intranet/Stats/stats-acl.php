...
for ($year = 2009; $year <= date('Y'); $year++) {
  ...
  //requête qui renvoie les ACL de l'ICA
	$url = 'https://api.archives-ouvertes.fr/search/?q=&fq=labStructId_i:110103&fq=docType_s:ART&fq=producedDateY_i:'.$year.'&fq=peerReviewing_t:oui&fq=popularLevel_t:non&wt=json&rows=10000&fl=docid,uri_s,label_s,localReference_s';
