...
<form id="inscription4" name="inscription" method="post" action="<?php site_url(); ?>/formulaire-inscription/">
  ...
  <label for="axe_1">Axe primaire : </label><select id="axe_1" name="axe_1">
    ...
    <option value="(MS2M) Méthodes et modèles numériques"> (MS2M) Méthodes et modèles numériques</option>
    <option value="(MS2M) Systèmes et microsystèmes mécatroniques et fluidiques"> (MS2M) Systèmes et microsystèmes mécatroniques et fluidiques</option>
    <option value="(MS2M) Comportement dynamique des matériaux et structures"> (MS2M) Comportement dynamique des matériaux et structures</option>
