...
?>
  <form METHOD='POST' ACTION='<?= site_url(); ?>/excel-des-publications/' CLASS='form-publi'>
    <input type="hidden" name="url" value=<?= $url ?>>
    <br /><button type=submit class='spanExcel'><i class='fa fa-table'></i>&nbsp &nbsp &nbsp<?= TXT_TELECHARGER_PUBLITACL ?></button><br />
  </form>
<?php
}
...
if ($nbResultats > 0) {
?>
  <table width=\"100%\" class=\" tab_publications tablesorter {sortlist:[[0,1]]}\">
    <col width='6%'>
    <col width='80%'>
    <col width='9%'>
    <thead>
      <tr>
        <th><?= TXT_ANNEE_PUBLITACL ?></th>
        <th><?= TXT_AUTEURDOC_PUBLITACL ?></th>
        <th><?= TXT_LIENS_PUBLITACL ?></th>
      </tr>
    </thead>
    <tbody>
      <?php
