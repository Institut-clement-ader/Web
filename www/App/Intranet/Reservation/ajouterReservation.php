                ...
                <div class="form-group">
                    ...
                    <select id="raison" required type="text" class="selectionForm" name="raison">
                        ...
                        <option value="Maintenance"
                            <?= (isset($_POST['raison']) && $_POST['raison'] == 'Maintenance') ? 'selected' : ''; ?>>
                            <?= TXT_MAINTENANCE ?>
                        </option>
                        <option value='Essai' <?= (isset($_POST['raison']) && $_POST['raison'] == 'Essai') ? 'selected' : ''; ?>> <?= TXT_ESSAI ?> </option>
                        <option value='Formation' <?= (isset($_POST['raison']) && $_POST['raison'] == 'Formation') ? 'selected' : ''; ?>> <?= TXT_FORMATION ?> </option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="encadrant" required type="text" class="selectionForm" name="encadrant" <?= ($status == "Doctorant") ? '' : 'disabled'; ?>>
                        ...
                        ?>
                                ...
                                <option value="<?= $nom ?>" <?= (isset($_POST['encadrant']) === $nom) ? 'selected' : ''; ?>> <?= $nom ?> </option>
                        <?php endforeach;
                        } ?>
                    </select>
                </div>
            ...
            <div class="form-simple">
                ...
                <select id="axe_recherche" required type="text" class="selectionForm" name="axe_recherche">
                    ...
                    foreach ($groupe as $resultat) : ?>
                        <option value='<?= $resultat[0] ?>' <?= (isset($_POST['axe_recherche']) === $resultat[0]) ? 'selected' : ''; ?>> <?= $resultat[0] ?> </option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="desc">
